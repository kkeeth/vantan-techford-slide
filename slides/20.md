...
<img src="https://www.qbook.jp/column/assets_c/2026/02/43690f6b78e868bfa8a155bd6eb456ce_1-thumb-autoxauto-q80.webp" alt="テストピラミッド" class="h-50 mx-auto" />
（image by: https://www.qbook.jp/column/1980.html）
...
├── components/
│   ├── HighlightText.tsx
│   ├── HighlightText.test.tsx    ← コンポーネントと同じ場所に
│   ├── SearchBar.tsx
│   └── SearchBar.test.tsx
├── utils/
│   ├── validator.ts
