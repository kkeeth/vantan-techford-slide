  ...
  return (
    <Box id="about" sx={{ py: 10, backgroundColor: 'background.paper' }}>
      <Container maxWidth="lg">
        ...
        <Typography sx={{ mb: 3, lineHeight: 1.7, fontSize: '1.1rem' }}>
          フロントエンド開発を中心に，ユーザーエクスペリエンスを重視した Web アプリケーションの開発を行っています．
        </Typography>
```
...
```tsx
            {/* 統計情報 */}
            <Box sx={{ display: 'flex', justifyContent: { xs: 'center', md: 'start' }, flexWrap: 'wrap', gap: 2, mt: 3 }}>
              <Box sx={{ textAlign: 'center' }}>
