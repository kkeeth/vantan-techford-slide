...
| 回          | テーマ                                   | 講義アジェンダ                                      |
| ------------- | -------------------------------------- | ------------------------------------------------- |
| <kbd>7~8</kbd>  | JavaScript を用いてテトリスを作成        |  |
| <kbd>9</kbd>  | UI コンポーネントライブラリを使ってみる       | リッチなデザインの Web サイトやアプリケーションを作るためのツール |
| <kbd>10-12</kbd>  | React に入門        | React を用いて簡単なアプリをハンズオンで作成  |
