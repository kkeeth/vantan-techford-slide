...
| <kbd>10</kbd>  | React でポートフォリオ開発<br />もくもく作業     | 最終成果物のポートフォリオのベースを作成        |
...
以下の公式サイトから LTS(推奨版：20.11.0)を
<br>ダウンロードしてインストール

<div>
  <a href="https://nodejs.org/" target="_blank" class="px-2 py-1 rounded cursor-pointer ring-inset bg-green-200">
