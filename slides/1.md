...
| <kbd>4</kbd> | CSS 基礎 ①                         | CSS とは/CSS のお作法/よく使う CSS プロパティ            |
...
| 日程          | テーマ                                   | 講義アジェンダ                                                |
| ------------- | ---------------------------------------- | ------------------------------------------------------------- |
| <kbd>7</kbd>  | JavaScript.js ①                          | JavaScript とは，JS の基礎文法/変数とデータ型/基本構文/演算子 |
...
| <kbd>11</kbd> | Firebase に入門                          | Firebase とは/Firebase の各サービス/タイマーアプリのデプロイ  |
...
| <kbd>13</kbd> | Vue.js 基礎 ②                                 | Vue.js のライフサイクルメソッドと DOM 構文                      |
