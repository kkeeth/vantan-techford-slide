...
<img src="/assets/1/kuwahara.jpg" class="rounded-full " alt="自画像">
...
この講義の最終目標は、フロントエンドフレームワーク **Vue.js** を利用し、簡単な SPA を 1 からフルスクラッチで作れる実力を身につけることです。
<br>
<br>
この最終目標を達成するために、JavaScript という言語の基本的な理解から、Vue.js の基礎、Vue.js を実際に使ってアプリを作る流れまでを学びます。
...
| <kbd>5</kbd> | JavaSript 基礎                  | JavaScript とは，JS の基礎文法/変数とデータ型/基本構文/演算子     |
| <kbd>6</kbd> | 簡単なカウントダウンアプリ開発ハンズオン | HTML/CSS/JS を利用して簡単なカウントダウンアプリを作成        |
...
| 日程          | テーマ                                   | 講義アジェンダ                                      |
| ------------- | -------------------------------------- | ------------------------------------------------- |
| <kbd>7</kbd>  | React の基本構文と Component，React Hooks | UI ライブラリ，React とは？，React の基礎            |
| <kbd>8</kbd>  | React で簡単な SPA 開発                     | React を用いて SPA の開発             |
| <kbd>9</kbd> | Firebase に入門                       | Firebase とは/Firebase の各サービス/カウントダウンアプリのデプロイ  |
| <kbd>10</kbd>  | React でポートフォリオ開発ハンズオン①     | 最終成果物のポートフォリオのベースを作成        |
| <kbd>11</kbd> | React でポートフォリオ開発ハンズオン②     | 自分たち用のホームページを作成        |
| <kbd>12</kbd> | 最終成果物の発表，クロージング             | 最終成果物の発表をお互いにフィードバック，発展，クロージング  |
...
12 週目からの講義で一緒に手を動かしながら作るアプリケーションのサンプルとなります。
...
「n」とは、Node.js のバージョン管理ツールの１つ。
同じ PC 内で様々なバージョンの Node を使い分けられます。
...
「nvm」は、「n」と同様に Node.js のバージョン管理ツールの１つ。
...
Cascading Style Sheets。HTML の体裁や見た目を表現するための言語、W3C 標準仕様で標準化されている。
...
ブラウザで動作する唯一のスクリプト言語で、Web ページ上で複雑な機能や動きを実現する。
<br>
<br>
動く Web ページ、モーダル、3D アニメーション、トラッキングや計量化対策など、Web でのあらゆる動作を行う。

※詳しくは 7, 8, 9 週 の JavaScript 基礎で触れます！
...
Google 製 OSS の JavaScript エンジン。2008 年ぐらいに公開され、Google Chrome や Node.js 等様々な所で使われている
...
高速な V8 JavaScript エンジンの登場に伴い、JavaScript(frontend)周りの技術進化が一気に起こった。
<br>
...
## 今回の JavaScript 初級クラス

フロントエンドフレームワークの Vue を学びます。
